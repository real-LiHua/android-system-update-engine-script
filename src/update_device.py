...
def CopyFileObjLength(
    fsrc, fdst, buffer_size=128 * 1024, copy_length=None, speed_limit=None
):
...
def PushMetadata(dut, otafile, metadata_path):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        with zipfile.ZipFile(otafile, "r") as zfp:
            ...
            with zfp.open("payload.bin") as payload_fp, open(
                extracted_path, "wb"
            ) as output_fp:
